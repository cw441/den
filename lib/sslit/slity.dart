...
class slty extends StatefulWidget {
  String name;
   slty({Key? key ,required this.name}) : super(key: key);

  @override
  State<slty> createState() => _sltyState(  name);
}

class _sltyState extends State<slty> {
  String name;
  _sltyState(this.name);
  @override
